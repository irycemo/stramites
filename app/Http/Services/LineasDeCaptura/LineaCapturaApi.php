            ...
            $response = Http::withBasicAuth($this->soapUserApi, $this->soapPasswordApi)->post($url, [
                "MT_ServGralLC_PI_Sender" => [
                    "ES_GEN_DATA" => [
                        ...
                        "OBSERVACIONES" => $this->tramite->año . '-' . $this->tramite->numero_control  . ' Fecha de entrega: ' . $this->tramite->fecha_entrega->format('d-m-Y') . ' pagando el ' . $this->tramite->created_at
                    ],
                    "TB_CONCEPTOS" => [
