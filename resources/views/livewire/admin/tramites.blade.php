        ...
        <x-slot name="content">
            ...
            @if(!$modelo_editar->movimiento_registral)
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 mb-3 gap-4">
                    ...
                    <div>
                        <x-input-group for="modelo_editar.numero_propiedad" label="Número de propiedad" :error="$errors->first('modelo_editar.numero_propiedad')">

                            <x-input-text type="number" id="modelo_editar.numero_propiedad" wire:model.lazy="modelo_editar.numero_propiedad" :disabled="$modelo_editar->folio_real != null"/>
