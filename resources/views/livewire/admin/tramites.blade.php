        ...
        <x-slot name="content">
            ...
            <div class="flex flex-col md:flex-row justify-between gap-3 mb-3">
                ...
                @if($modelo_editar->folio_real)
                    ...
                    <x-input-group for="modelo_editar.folio_real" label="Folio real" :error="$errors->first('modelo_editar.folio_real')" class="w-full">

                        <x-input-text id="modelo_editar.folio_real" wire:model="modelo_editar.folio_real" />
                ...
                @if($modelo_editar->tomo)
                    ...
                    <x-input-group for="modelo_editar.tomo" label="Tomo" :error="$errors->first('modelo_editar.tomo')" class="w-full">
                        ...
                        <x-input-text id="modelo_editar.tomo" wire:model="modelo_editar.tomo" />
                ...
                @if($modelo_editar->registro)
                    ...
                    <x-input-group for="modelo_editar.registro" label="Registro" :error="$errors->first('modelo_editar.registro')" class="w-full">
                        ...
                        <x-input-text id="modelo_editar.registro" wire:model="modelo_editar.registro" />
                ...
                @if($modelo_editar->seccion)
                    ...
                    <x-input-group for="modelo_editar.seccion" label="Sección" :error="$errors->first('modelo_editar.seccion')" class="w-full">
                        ...
                        <x-input-select id="modelo_editar.seccion" wire:model="modelo_editar.seccion" class="w-full">
                ...
                @if($modelo_editar->distrito)
                    ...
                    <x-input-group for="modelo_editar.distrito" label="Distrito" :error="$errors->first('modelo_editar.distrito')" class="w-full">
                        ...
                        <x-input-select id="modelo_editar.distrito" wire:model="modelo_editar.distrito" class="w-full">
                ...
                @if($modelo_editar->registro_gravamen)
                    ...
                    <x-input-group for="modelo_editar.registro_gravamen" label="Registro de gravamen" :error="$errors->first('modelo_editar.registro_gravamen')" class="w-full">
                        ...
                        <x-input-text id="modelo_editar.registro_gravamen" wire:model="modelo_editar.registro_gravamen" />
                ...
                @if($modelo_editar->tomo_gravamen)
                    ...
                    <x-input-group for="modelo_editar.tomo_gravamen" label="Tomo de gravamen" :error="$errors->first('modelo_editar.tomo_gravamen')" class="w-full">

                        <x-input-text id="modelo_editar.tomo_gravamen" wire:model="modelo_editar.tomo_gravamen" />
                ...
                @if($modelo_editar->numero_propiedad)
                    ...
                    <x-input-group for="modelo_editar.numero_propiedad" label="Número de propiedad" :error="$errors->first('modelo_editar.numero_propiedad')" class="w-full">
                        ...
                        <x-input-text id="modelo_editar.numero_propiedad" wire:model="modelo_editar.numero_propiedad" />
                ...
                @if($modelo_editar->numero_inmuebles)
                    ...
                    <x-input-group for="modelo_editar.numero_inmuebles" label="Número de inmuebles" :error="$errors->first('modelo_editar.numero_inmuebles')" class="w-full">

                        <x-input-text id="modelo_editar.numero_inmuebles" wire:model="modelo_editar.numero_inmuebles" />
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                        ...
                        @if ($modelo_editar->fecha_emision)
                            ...
                            <div class="rounded-lg bg-gray-100 py-1 px-2">
                                ...
                                <p><strong>Fecha de emisión:</strong> {{ $modelo_editar->fecha_emision->format('d-m-Y') }}</p>
