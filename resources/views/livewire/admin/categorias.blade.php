                ...
                @forelse ($this->categorias as $categoria)
                    ...
                    <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $categoria->id }}">
                        ...
                        <x-table.cell>
                            ...
                            <p class="mt-2">{{ $categoria->nombre }}</p>
                                ...
                                <div x-cloak x-show="open_drop_down" x-on:click="open_drop_down=false" x-on:click.away="open_drop_down=false" class="z-50 origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                                    ...
                                    @can('Editar categoría')
                                        ...
                                        <button
                                            ...
                                            wire:target="abrirModalEditar({{ $categoria->id }})"
    ...
    <x-dialog-modal wire:model="modal" maxWidth="sm">
        ...
        <x-slot name="content">
            ...
            <div class="flex flex-col md:flex-row justify-between gap-3 mb-3">
                ...
                <x-input-group for="modelo_editar.concepto" label="Concepto" :error="$errors->first('modelo_editar.concepto')" class="w-full">

                    <x-input-text id="modelo_editar.concepto" wire:model="modelo_editar.concepto" />
            ...
            <div class="flex flex-col md:flex-row justify-between gap-3 mb-3">
                ...
                <x-input-group for="modelo_editar.seccion" label="Sección" :error="$errors->first('modelo_editar.seccion')" class="w-full">
                    ...
                    <x-input-text type="number" id="modelo_editar.seccion" wire:model="modelo_editar.seccion" />
